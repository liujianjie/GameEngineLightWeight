...
namespace Hazel {
	...
	public:
		...
		static void DrawQuad(const glm::mat4& transform, const glm::vec2& size, const Ref<Texture2D>& texture, float tilingFactor = 1.0f, const glm::vec4& tintColor = glm::vec4(1.0f));
